...
OUTPUT_DATASET = MODELING_DIR / "churn_modeling_dataset_it_3c_top75.csv"
REPORT_CSV = MODELING_DIR / "feature_selection_report_it_3c_top75.csv"
REPORT_JSON = MODELING_DIR / "feature_selection_summary_it_3c_top75.json"
...
def build_reduced_dataset() -> dict[str, Path]:
        ...
        rows.append(
            {
                ...
                "reason": "top75_it_3a" if col in top_features else "id_target" if col in ID_AND_TARGET_COLS else "fuera_top75",
            }
        )
    ...
    summary = {
        ...
        "selection_rule": "top 75 features originales agrupadas desde feature importance de Iteracion 3A",
        "important_notes_for_results_review": [
            "3C limpio: mismos hiperparametros que Iteracion 2/3A, sin tuning.",
            "Objetivo: comprobar si Top 75 dentro de 3A mantiene rendimiento.",
            "Si mantiene rendimiento, considerar 3C como dataset interpretable principal.",
            "Si cae, probar Top 100 o tuning ligero de XGBoost como comparacion secundaria.",
        ],
