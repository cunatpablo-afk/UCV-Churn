...
## Iteracion 3B:
## Dataset reducido 3A + contexto geografico agregado no identificativo.
##
## Recordatorio para interpretar resultados:
## - 3A: sin variables geograficas directas.
## - 3B: con agregados por zona/region, pero sin IDs directos.
...
## - Revisar si las top features vuelven a estar dominadas por contexto geografico.

REDUCED_DATASET = MODELING_DIR / "churn_modeling_dataset_it_3b.csv"

base.RUN_SUFFIX = "it_3b"
...
def load_modeling_dataset() -> pd.DataFrame:
    ...
    if not REDUCED_DATASET.exists():
        raise FileNotFoundError(
            f"No existe {REDUCED_DATASET}. Ejecuta primero src/features/build_reduced_dataset_it_3b.py."
        )
