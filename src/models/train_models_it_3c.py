...
## Iteracion 3C:
## Dataset Top 75 dentro de 3A, sin geografia directa.
## No hay tuning: se mantienen hiperparametros de Iteracion 2/3A para aislar
## el efecto de reducir variables.

REDUCED_DATASET = MODELING_DIR / "churn_modeling_dataset_it_3c_top75.csv"

base.RUN_SUFFIX = "it_3c_top75"
...
def load_modeling_dataset() -> pd.DataFrame:
    ...
    if not REDUCED_DATASET.exists():
        raise FileNotFoundError(
            f"No existe {REDUCED_DATASET}. Ejecuta primero src/features/build_reduced_dataset_it_3c_top75.py."
        )
